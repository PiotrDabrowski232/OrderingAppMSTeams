...
namespace OrderingApp.Logic.DTO
{
    public class OrderDto
    {
        ...
        [Range(0.01, double.MaxValue, ErrorMessage = "Minimum value must be greater than 0.")]
        public float MinValue { get; set; }

        [Required(ErrorMessage = "Delivery Cost is required.")]
        [Range(0, double.MaxValue, ErrorMessage = "Delivery cost must be non-negative.")]
        public float DeliveryCost { get; set; }

        [Required(ErrorMessage = "Free Delivery From is required.")]
        [Range(0, double.MaxValue, ErrorMessage = "Free delivery must be greater than or equal to 0.")]
